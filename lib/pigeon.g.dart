...
class PlatformService {
  ...
  Future<void> addImgToCtx(Uint8List image) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.flutter_gemma.PlatformService.addImgToCtx$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> addAudioToCtx(Uint8List audio) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.flutter_gemma.PlatformService.addAudioToCtx$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    ...
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_channel.send(<Object?>[audio]) as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
      throw PlatformException(
